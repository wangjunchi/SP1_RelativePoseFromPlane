...
import kornia
import kornia.geometry.homography as H
...
class DSACSoftmax(torch.nn.Module):
    ...
    def __sample_hypotheses(points1, points2, batch_size, points_per_hypothesis, hypothesis_no):
        ...
        homographies = H.find_homography_dlt(points1_sampled, points2_sampled)
    ...
    def __score_hypotheses(self, points1, points2, homographies, batch_size, hypothesis_no):
        ...
        # Transform points
        points1_transformed = kornia.geometry.linalg.transform_points(homographies, points1)                            # [B*n, N, 2]
