...
from PlaneMatching.layers.pooling import MAC, SPoC, GeM, GeMmp, RMAC, Rpool
from PlaneMatching.layers.normalization import L2N, PowerLaw
...
class ImageRetrievalNet(nn.Module):
    ...
    def forward(self, x, plane_mask=None):
        # x -> features
        o = self.features(x)
